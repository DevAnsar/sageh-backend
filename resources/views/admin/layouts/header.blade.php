    ...
    <div class="navbar-header">
        <div class="container-fluid">
            <div class="float-right">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <img class="rounded-circle header-profile-user" src="{{auth()->user()->avatar?getImage(auth()->user()->avatar['url']):asset('admin/assets/images/users/avatar-2.jpg')}}"
                             alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <form action="{{route('logout')}}" method="post" id="LogOut">@csrf @method('POST')</form>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="dropdown dropdown-mega d-none">
                    <button type="button" class="btn header-item waves-effect" data-toggle="dropdown"
